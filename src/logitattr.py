...
# 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

# 2: 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

login(token="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", add_to_git_credential=True)
...
prompts = prompts[30:33]
answers = answers[30:33]
...
tokens = model.tokenizer(prompts, padding="max_length")
